...
Thanks to https://canary.gitlab.com/antora/antora.org/issues/20[this list] of sites using Antora, I found a site that displays a sidebar of headings in the current page, if the page has H2 or lower headings.  That site was https://across-docs.foreach.be/across-site/preview/across/2.1.2-dev/index.html[Across Platform documentation].

image:across-sidebar-toc.png[]

I downloaded the UI https://github.com/ForeachOS/ax-docs-across-site-ui[here]. Here are the steps I followed to add an article-level TOC to my custom Antora UI.
