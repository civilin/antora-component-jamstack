...
You can display an external web page inside an AsciiDoc file, by placing an HTML iframe element in a xref:iframe.adoc#code-listing[passthrough block]. A few lines of CSS will make the iframe responsive. Here's an example, courtesy of the US Postal Service: +
 +
