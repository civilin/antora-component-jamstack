...
You can display an external web page within an AsciiDoc file, by placing an HTML iframe element with CSS to make the iframe responsive, in a passthrough block. For example: +
 +
