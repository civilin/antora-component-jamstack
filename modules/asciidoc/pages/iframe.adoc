...
You can display an external web page inside an AsciiDoc file, by placing an HTML iframe element in a passthrough block. A few lines of CSS will make the iframe responsive. Here's an example, courtesy of the US Postal Service: +
 +
...
.Copy this code block into your AsciiDoc file:
[source, html]
----
++++
<!-- HTML to embed an iframe -->
